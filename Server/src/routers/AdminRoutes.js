...
router.get('/products/phone', (req, res) => adminController.getAllPhone(req, res));
router.get('/products/mouse', (req, res) => adminController.getAllMouse(req, res));
router.get('/products/keyboard', (req, res) => adminController.getAllKeyboard(req, res));
router.get('/products/computers',  (req, res) => adminController.getAllComputers(req, res));
router.get('/products/processors', (req, res) => adminController.getAllProcessors(req, res));
router.get('/products/tablet',  (req, res) => adminController.getAllTablet(req, res));
router.get('/products/gamingear', (req, res) => adminController.getAllGamingGear(req, res));
router.get('/products/ram',  (req, res) => adminController.getAllRAM(req, res));
router.get('/products/storage',  (req, res) => adminController.getAllStorage(req, res));
router.get('/products/cases',  (req, res) => adminController.getAllCase(req, res));
router.get('/products/mainboards',  (req, res) => adminController.getAllMainboard(req, res));
...
router.get('/products/headphones',  (req, res) => adminController.getAllHeadphone(req, res));
router.get('/products/mousepads',  (req, res) => adminController.getAllMousepad(req, res));
