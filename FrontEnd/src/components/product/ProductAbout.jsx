      ...
      <div className="border border-gray-400 rounded-lg p-4">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0 bg-gray-100 p-6 rounded-lg">
            ...
            <p className="mb-4">MSI MPG Trident 3 10SC-005AU Intel i7 10700F, 2060 SUPER, 16GB RAM, 512GB SSD, 2TB HDD, Windows 10 Home, Gaming Keyboard and Mouse, 3 Years Warranty Gaming Desktop</p>
