...
const Header = () => {
  ...
  return (
    <header className="font-sans">
      ...
      {/* Main Navigation Bar */}
      <div className="bg-white border-b border-gray-200 flex justify-between items-center px-2 py-3">
        {/* Logo */}
        <img src={logo} alt="Logo" className="mr-6 h-8  rounded-none" />
            ...
            {showDropdown && (
              <div className="absolute right-0 w-48 mt-2 bg-white border rounded shadow-lg z-10">
                <div className="p-3 border-b">
                  <p className="text-sm text-gray-500">
                    {user ? `Hello, ${user.fullName}` : "Hello, please log in"}
                  </p>
                </div>
                <ul className="py-1">
                  {user ? (
