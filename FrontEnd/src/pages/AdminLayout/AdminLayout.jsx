        ...
        <div key={category.categoryName}>
          ...
          <div className="w-full bg-gray-700 rounded-full h-2">
            ...
            ></div>
                      ...
                      return (
                        <div className={`p-4 rounded-lg border ${borderColor}`} key={product.productId}>
                          <div className="flex items-center mb-2">
                            ...
                            >
                              <div className={`text-${color}-500`}>{icons[index % icons.length]}</div>
                            </div>
                            <div>
                          ...
                          <div className="flex justify-between text-sm mt-2">
                            ...
                            <span
                              className={
                                product.percentChange >= 0 ? 'text-green-500 flex items-center' : 'text-red-500 flex items-center'
                              }
                            >
              ...
              <div className={`p-6 rounded-lg ${cardBg} border ${borderColor}`}>
                <div className="flex justify-between items-center mb-6">
                  <h3 className="text-lg font-medium textsac-blue-500">Recent Orders</h3>
