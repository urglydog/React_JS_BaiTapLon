...
export default function ComputerStoreAdminLayout() {
  ...
  const performProductOperation = async (
    ...
    if (operation === "update" && productData.categoryID) {
  ...
  const updateOrderStatus = async (orderId, status) => {
    try {
      ...
      // Cập nhật trực tiếp orders thay vì fetch lại
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.log("Dashboard stats data from API:", statsData);
        ...
        if (!topSpendersResponse.ok)
          throw new Error("Failed to fetch top spenders data");
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                >
                  ...
                  <p className="text-3xl font-bold">
                    ...
                    {dashboardStats?.totalRevenue?.value
                      ? new Intl.NumberFormat("vi-VN", {
                          style: "currency",
                          currency: "VND",
                        }).format(dashboardStats.totalRevenue.value)
                      : "0 ₫"}
                  </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                >
                    ...
                    {Array.isArray(deviceUsage) &&
                      deviceUsage.map((device, index) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`rounded-lg w-12 h-16 mb-2 flex items-center justify-center relative ${
                                isHighlight
                                  ? darkMode
                                    ? "bg-blue-900"
                                    : "bg-blue-400"
                  ...
                  {/* Chart */}
                  <div className="mt-6 p-2 border-t border-gray-300 dark:border-gray-600">
                        ...
                        recentOrders.map((order) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="py-3">{order.productNames}</td>
              ...
              >
                ...
                <div className="h-64 w-full">
                  {topSpenders && topSpenders.length > 0 ? (
                    ...
                    <div className="flex items-center justify-center h-full">
                      <p>
                        No top spenders data available for the selected
                        timeframe
                      </p>
                    </div>
                  )}
          ...
          {activeMenu === "Storage" && (
            <div className="p-6">
              <Storage
                ...
                deleteProduct={(productId) =>
                  deleteProduct("storage", productId)
                }
                getProductById={getProductById}
          ...
          {activeMenu === "Tablet" && (
            <div className="p-6">
              <TabletTable
                ...
                deleteProduct={(productId) =>
                  deleteProduct("tablet", productId)
                }
                getProductById={getProductById}
          ...
          {activeMenu === "Laptops" && (
            <div className="p-6">
              <LaptopTable
                ...
                deleteProduct={(productId) =>
                  deleteProduct("laptop", productId)
                }
                getProductById={getProductById}
...
// Đặt formatter rút gọn: 1,000 -> 1K, 1,000,000 -> 1M
      ...
      <LineChart data={chartData}>
        ...
        <Tooltip
          contentStyle={{
            ...
            whiteSpace: "nowrap", // Ngăn tooltip bị bể dòng
          }}
      ...
      <div className="w-3/4 flex items-center justify-center">
        <PieChart width={360} height={240}>
          <Pie
            ...
            dataKey="value"
            nameKey="name"
            label={false} // ẩn label trên biểu đồ
          >
...
function CategorySalesChart({ data, darkMode }) {
  ...
  console.log("Category Chart Data:", chartData); // Log để kiểm tra dữ liệu
