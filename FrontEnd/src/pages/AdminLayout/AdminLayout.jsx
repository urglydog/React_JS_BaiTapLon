...
//                   {/* Here you would render your chart using a library like Recharts */}
//                   {/* Placeholder for the actual chart */}
//                   <div className="text-center">
//                     <div className="text-blue-500 text-xl mb-2">Monthly Sales Performance</div>
//                     <p className={secondaryTextColor}>
//                       {timeframe === 'last7days' && 'Showing sales data from the last 7 days'}
//                       {timeframe === 'last30days' && 'Showing sales data from the last 30 days'}
//                       {timeframe === 'lastQuarter' && 'Showing sales data from the last quarter'}
//                       {timeframe === 'lastYear' && 'Showing sales data from the last year'}
//                     </p>
//                   </div>
//                 </div>
//               ) : (
...
//                 {deviceUsage && deviceUsage.map((device, index) => {
//                   let icon;
